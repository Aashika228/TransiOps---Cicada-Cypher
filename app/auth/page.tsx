      ...
      <div className="hidden lg:flex w-1/2 relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #050d1a 0%, #0a1628 100%)' }}>
        ...
        <div className="relative z-10 p-16 flex flex-col justify-between h-full">
          <Link href="/" className="flex items-center gap-2 cursor-pointer w-fit">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-emerald-400 to-cyan-500 flex items-center justify-center shadow-lg dark:shadow-none shadow-emerald-500/20">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-slate-400 dark:text-slate-500 max-w-md">
          ...
          <div className="flex gap-8 border-t border-white/10 pt-8">
            <div>
              ...
              <p className="text-sm text-slate-400 dark:text-slate-500 mt-1">Fleets Managed</p>
            </div>
            <div>
              <p className="text-3xl font-display font-bold text-white">99.9%</p>
              <p className="text-sm text-slate-400 dark:text-slate-500 mt-1">Platform Uptime</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 relative">
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <Link href="/" className="lg:hidden flex items-center gap-2 mb-12 justify-center">
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-emerald-400 to-cyan-500 flex items-center justify-center shadow-lg dark:shadow-none shadow-emerald-500/20">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-3xl p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 dark:border-slate-800">
            {/* Role Selection */}
            <div className="mb-8">
              <label className="block text-sm font-semibold text-slate-700 dark:text-slate-300 mb-3">Select your role</label>
                  ...
                  return (
                    <button
                      ...
                      className={`flex flex-col items-center gap-2 p-3 rounded-xl transition-all duration-200 border ${
                        isSelected 
                          ? 'border-transparent shadow-sm dark:shadow-none' 
                          : 'border-slate-200 dark:border-slate-800 hover:border-slate-300 dark:border-slate-700 hover:bg-slate-50 dark:bg-slate-800'
                      }`}
                    ...
                    >
                      ...
                      <span className={`text-xs font-semibold ${isSelected ? 'text-slate-900 dark:text-slate-50' : 'text-slate-500 dark:text-slate-400 dark:text-slate-500'}`}>
                        {role.id}
                      </span>
                    </button>
                  )
            ...
            <form className="space-y-5" onSubmit={(e) => { e.preventDefault(); window.location.href = `/dashboard?role=${selectedRole.toLowerCase().replace(' ', '-')}` }}>
              {!isLogin && (
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="text"
                      className="w-full pl-10 pr-4 py-3 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-800 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all"
              ...
              <button
                type="submit"
                className="w-full group inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-xl font-semibold text-white transition-all duration-300 hover:shadow-lg dark:shadow-none mt-2"
                style={{
            ...
            <div className="mt-8 text-center">
              <p className="text-sm text-slate-500 dark:text-slate-400 dark:text-slate-500">
                ...
                <button
                  ...
                  className="font-semibold text-slate-900 dark:text-slate-50 hover:text-emerald-600 transition-colors"
                >
